...
export default function HeroIntro() {
  ...
  return (
    <section className="relative min-h-[60vh] sm:min-h-[65vh] md:min-h-[70vh] flex flex-col justify-center py-10 sm:py-14 md:py-20 px-4 overflow-hidden w-full bg-[#faf8f5] dark:bg-gray-900/95">
      <AmbientBackground />
      ...
      <div className="relative max-w-6xl mx-auto w-full text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-6 sm:mb-8">
          ...
          >
            <MessageCircle className="inline-block mr-2 w-5 h-5" aria-hidden />
