            ...
            <section className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-sm overflow-hidden">
              <details className="group">
                ...
                <div className="px-4 pb-4 text-sm text-gray-700 dark:text-gray-300 space-y-2">
                  ...
                  <p>
                    • <strong>Facturación disponible</strong> para empresas y profesionales
                  </p>
                  <p>
            ...
            <section className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-sm overflow-hidden">
              <details className="group">
                ...
                <div className="px-4 pb-4 text-sm text-gray-700 dark:text-gray-300 space-y-2">
                  ...
                  <p>
                    • <strong>Asesoría técnica</strong> sobre códigos, medidas y compatibilidad
                  </p>
                  <p>
                    • <strong>Seguimiento de pedidos</strong> con guía de paquetería
                  </p>
                  <p>
