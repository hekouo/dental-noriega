  ...
  return (
    <div className="max-w-4xl mx-auto py-12">
      ...
      <div className="prose prose-gray max-w-none">
        <p className="mb-4">
          En DENTAL NORIEGA respetamos tu privacidad y nos comprometemos a proteger tus datos personales.
        </p>
        ...
        <h2 className="text-xl font-semibold mt-6 mb-3">Uso de la información</h2>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          para completar tu pedido (por ejemplo, servicios de mensajería).
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-3">Tus derechos</h2>
        <p className="mb-4">
          Tienes derecho a acceder, corregir o eliminar tus datos personales en cualquier momento.
          Para ejercer estos derechos, contáctanos por correo electrónico a{' '}
          <a href="mailto:dental.noriega721@gmail.com" className="text-blue-600 hover:underline">
        ...
        <p className="mb-4">
          Utilizamos cookies esenciales para el funcionamiento del sitio web y para guardar
          tu carrito de compras localmente en tu navegador.
        </p>
