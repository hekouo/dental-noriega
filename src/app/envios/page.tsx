  ...
  return (
    <div className="max-w-4xl mx-auto py-12">
      ...
      <div className="prose prose-gray max-w-none">
        ...
        <p className="mb-4">
          Realizamos envíos a toda la República Mexicana. Los tiempos de entrega varían según la ubicación.
        </p>
        ...
        <p className="mb-4">
          También puedes recoger tu pedido sin costo en nuestra ubicación en Ciudad de México.
          Contáctanos por WhatsApp para coordinar la recogida.
        </p>
