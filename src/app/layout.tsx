        ...
        <CartProvider>
          <header className="border-b bg-white sticky top-0 z-40">
            <nav className="max-w-6xl mx-auto flex items-center justify-between p-4 gap-4">
              ...
              {/* Buscador */}
              <form action="/buscar" method="GET" className="hidden md:flex items-center gap-2 flex-1 max-w-md">
                ...
                <button className="btn btn-primary px-3 py-2 rounded-lg text-sm" type="submit">
                  <span>Buscar</span>
                </button>
              </form>

              <div className="flex items-center gap-4 text-sm">
                <Link href={ROUTES.catalogIndex()} className="min-h-[44px] flex items-center">
                  <span className="hover:text-primary-600">Catálogo</span>
                </Link>
                <Link href={ROUTES.destacados()} className="min-h-[44px] flex items-center">
