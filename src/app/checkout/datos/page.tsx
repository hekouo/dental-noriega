...
const PICKUP_LOCATIONS = [
  ...
  { id: '2', name: 'Sucursal Sur', address: 'Av. Insurgentes Sur 456, Del Valle, CDMX' },
]
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-6">
              ...
              {method === 'shipping' ? (
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  {addresses.length === 0 ? (
                    <p className="text-gray-600">
                      ...
                      <a href="/cuenta/direcciones" className="text-primary-600 hover:underline">
                      ...
                      {addresses.map((address) => (
                        ...
                        >
                          ...
                          <p className="text-sm text-gray-600">
                            {address.street} {address.ext_no}, {address.neighborhood}
                            <br />
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  <h2 className="text-xl font-semibold mb-4">Punto de Recogida</h2>
                  <div className="space-y-3">
              ...
              {profile && profile.points_balance > 0 && (
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Tienes <strong>{profile.points_balance} puntos</strong> disponibles
                    (equivalentes a {formatCurrency(calculatePointsValue(profile.points_balance))})
                  </p>
                  <div>
                    <label className="label">Puntos a canjear (máximo: {maxRedeemable})</label>
                    <input
                      type="number"
                      min="0"
                      max={maxRedeemable}
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow p-6 sticky top-24">
                ...
                <button
                  type="submit"
                  disabled={isSubmitting || (method === 'shipping' && !selectedAddressId) || (method === 'pickup' && !selectedPickupId)}
