  ...
  return (
    <AuthGuard>
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="space-y-4 mb-8">
            ...
            <div className="flex items-start gap-4">
              <div
                className={`p-3 rounded-full ${
                  method === 'shipping' ? 'bg-primary-600 text-white' : 'bg-gray-100'
                }`}
              >
                <Truck size={24} />
              </div>
              <div className="flex-1 text-left">
                <h3 className="font-semibold text-lg mb-1">Entrega a domicilio</h3>
              ...
              <div
                className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                  method === 'shipping' ? 'border-primary-600' : 'border-gray-300'
                }`}
              >
                {method === 'shipping' && (
          ...
          >
            <div className="flex items-start gap-4">
              <div
                className={`p-3 rounded-full ${
                  method === 'pickup' ? 'bg-primary-600 text-white' : 'bg-gray-100'
                }`}
              >
                <Store size={24} />
              </div>
              <div className="flex-1 text-left">
                <h3 className="font-semibold text-lg mb-1">Recoger en tienda</h3>
                <p className="text-gray-600 text-sm">
                  Recoge tu pedido en nuestra sucursal
                </p>
                <p className="text-sm text-primary-600 mt-2">Sin costo de envío</p>
              </div>
              <div
                className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
        ...
        <button onClick={handleContinue} className="w-full btn btn-primary text-lg">
          Continuar
        </button>
      </div>
    </AuthGuard>
