  ...
  return (
    <div className="max-w-4xl mx-auto py-12">
      ...
      <div className="prose prose-gray max-w-none">
        ...
        <p className="mb-4">
          Aceptamos devoluciones y cambios dentro de los primeros 7 días después
          de recibir tu pedido, siempre y cuando el producto esté en su empaque
          original y sin usar.
        </p>
        ...
        <ol className="list-decimal pl-6 mb-4">
          <li>
            Contacta con nosotros por WhatsApp indicando tu número de pedido
          </li>
          <li>Espera la confirmación y las instrucciones de devolución</li>
          <li>Envía el producto de vuelta en su empaque original</li>
          <li>
            Una vez recibido y revisado, procesaremos tu reembolso o cambio
          </li>
        </ol>
